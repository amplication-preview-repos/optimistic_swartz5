...
export class UserGrpcControllerBase {
  ...
  @GrpcMethod("UserService", "findManyPlaylists")
  ...
  @GrpcMethod("UserService", "connectPlaylists")
  ...
  @GrpcMethod("UserService", "updatePlaylists")
  ...
  @GrpcMethod("UserService", "disconnectPlaylists")
